    ...
    <div className='flex flex-col space-x-3 border-y p-5 border-gray-100'>
        ...
        {commentBoxVisible && (
            <form className='mt-3 flex space-x-3'>
                <input className='flex-1 rounded-lg bg-gray-100 p-2 outline-none' type="text" placeholder="Write a comment"/>
                <button className='text-buzz disabled:text-gray-200'>Post</button>
            </form>
        )}
